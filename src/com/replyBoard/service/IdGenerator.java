...
public class IdGenerator {
	...
	public int generateNextId(String sequenceName, Connection conn)
		...
		try {
			pstmtSelect = conn
					.prepareStatement("select next_value from id_sequence "
			...
			pstmtUpdate = conn
					.prepareStatement("update id_sequence set next_value = ? "
							+ "where sequence_name = ?");
